...
const SidebarItem = ({issue, report}) => {
  ...
  return (
    <div className='SidebarItem'>
        ...
        <div className='SidebarItem_Temp'>
            <img src="../../src/assets/Temp.png" alt="" className='SidebarItem_TempIcon' />
            <span className='SidebarItem_TempValue'>
                {issue.temperature}°C
            </span>
        </div>
        <div className='SidebarItem_Message'>
        ...
        <div className='SidebarItem_Footer'>
            ...
            <div className='SidebarItem_Date'>
                {report ? new Date(report.handled_at).toLocaleDateString() : new Date(issue.created_at).toLocaleDateString()}
            </div>
        </div>
    </div>
  )
