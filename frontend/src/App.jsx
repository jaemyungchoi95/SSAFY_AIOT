...
import { AlertStateContext, ReportStateContext, WarehouseStateContext} from './utils/AlertContext'
...
const alertMockData = [
  ...
  },
  {
    ...
    updated_at: new Date(new Date().getTime() - 5 * 24 * 60 * 60 * 1000).toISOString()
  },
  {
    id: 3,
    robot_id: 1,
    ...
    status: "UNCHECKED",
    is_danger: false,
    created_at: new Date(new Date().getTime() - 9 * 24 * 60 * 60 * 1000).toISOString(),
    updated_at: new Date(new Date().getTime() - 9 * 24 * 60 * 60 * 1000).toISOString(),
  },
  {
    id: 4,
    robot_id: 1,
...
const reportMockData = [
  {
    ...
    alert_id: 2,
    user_id: 1,
    handled_at: new Date(new Date().getTime() - 5 * 24 * 60 * 60 * 1000).toISOString(),
    handler_name: "김철수",
    item_type: "oil",
    rack_id: 5,
    comment: "온도 변화 이상"
